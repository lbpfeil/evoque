...
import { X, Plus, Trash2, Edit2, ChevronRight, ChevronDown, Folder, Tag as TagIcon } from 'lucide-react';
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-[400px] sm:w-[540px] flex flex-col h-full">
                <SheetHeader className="mb-6">
                    ...
                    <SheetDescription>
                        Organize your tags hierarchically. Use drag and drop to reorder (coming soon).
                    </SheetDescription>
                </SheetHeader>
