            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                <div className="flex items-center justify-between p-4 border-b border-zinc-100">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-semibold text-zinc-900">Learning Curve</h3>
                    </div>
                ...
                <div className="p-6 overflow-y-auto">
                    <div className="mb-6">
                        <p className="text-sm text-zinc-500 italic mb-2">"{highlight.text.substring(0, 100)}{highlight.text.length > 100 ? '...' : ''}"</p>
                    </div>
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-4">
                        <div className="bg-zinc-50 p-3 rounded-md text-center">
                            <p className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Repetitions</p>
                            <p className="text-xl font-bold text-zinc-900">{card?.repetitions || 0}</p>
                        </div>
                        <div className="bg-zinc-50 p-3 rounded-md text-center">
                            <p className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Ease Factor</p>
                            <p className="text-xl font-bold text-zinc-900">{card?.easeFactor?.toFixed(2) || '-'}</p>
                        </div>
                        <div className="bg-zinc-50 p-3 rounded-md text-center">
                            <p className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Next Review</p>
