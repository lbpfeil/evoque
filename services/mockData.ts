...
export const MOCK_HIGHLIGHTS: Highlight[] = [
  { id: 'h1', bookId: 'b1', text: 'You do not rise to the level of your goals. You fall to the level of your systems.', location: '27', dateAdded: new Date().toISOString() },
  { id: 'h2', bookId: 'b1', text: 'Habits are the compound interest of self-improvement.', location: '15', dateAdded: new Date().toISOString() },
  ...
  { id: 'h6', bookId: 'b2', text: 'Nothing in life is as important as you think it is, while you are thinking about it.', location: '402', dateAdded: new Date().toISOString() },
  { id: 'h7', bookId: 'b2', text: 'We are prone to overestimate how much we understand about the world.', location: '15', dateAdded: new Date().toISOString() },
  ...
  { id: 'h9', bookId: 'b3', text: 'The ability to perform deep work is becoming increasingly rare at exactly the same time it is becoming increasingly valuable in our economy.', location: '12', dateAdded: new Date().toISOString() },
