# Requirements Archive: v2.0 Design System Overhaul
...
- [x] **TOKENS-01**: Escala tipografica com 6 tamanhos nomeados e regras estritas por contexto (display, title, heading, body, caption, overline)
- [x] **TOKENS-02**: Escala de espacamento com 8 tokens semanticos em grid de 4px
- [x] **TOKENS-03**: Escala de border-radius com exatamente 3 valores (sm, md, lg)
- [x] **TOKENS-04**: Escala de shadows com exatamente 3 elevacoes
- [x] **TOKENS-05**: Motion tokens -- 3 duracoes + 3 easings como CSS custom properties
- [x] **TOKENS-06**: Escala de icones com exatamente 3 tamanhos (14px, 16px, 20px)
- [x] **TOKENS-07**: Sistema de z-index com 7 camadas semanticas
...
- [x] **COMP-03**: Criar padrao de data table padronizado -- estrutura de tabela reutilizavel unica *(removed -- orphaned, YAGNI)*
...
- [x] **PAGE-05**: Migrar BookDetails para padroes canonicos *(N/A -- page removed)*
...
**Adjusted:**
- COMP-03 (DataTable) removed after creation -- 0 imports, YAGNI
- PAGE-05 (BookDetails) N/A -- page was removed from app
