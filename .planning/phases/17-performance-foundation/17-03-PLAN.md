...
<task type="auto">
  ...
  <action>
    ...
    IMPORTANT for Sidebar.tsx: This task also modifies Sidebar.tsx. Plan 17-01 also modifies Sidebar.tsx (adding prefetch). Since Plan 01 and 03 are both Wave 1, there is a potential file conflict. However, the changes are in different parts of the file:
    ...
    If Plan 01 runs first, this task should apply cleanly to the already-modified file. If there is a merge issue, read the current file state and apply changes on top.
  </action>
  <verify>
