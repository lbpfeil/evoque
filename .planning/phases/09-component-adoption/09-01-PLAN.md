...
<task type="auto">
  ...
  **ErrorBoundary.tsx** (1 button):
  ...
  <done>Sidebar.tsx, ThemeToggle.tsx, and ErrorBoundary.tsx all use Button component. Zero raw button elements remain in these 3 files.</done>
</task>
...
4. All 4 files import Button from ui/button
5. Login.tsx additionally imports Input from ui/input
</verification>
